class AnswersController < ApplicationController
  ...
  private
  def answer_params
    params.require(:answer).permit(:text, :knowledge_basis_id, :created_by, :off_topic, questions_attributes: [:id, :text, :answer_id, :knowledge_basis_id, :user_session_id, :assigned_by, :confirmed_at, :probability, :_destroy], placeholders_attributes: [:id, :replaceable_type, :replaceable_id])
  end
